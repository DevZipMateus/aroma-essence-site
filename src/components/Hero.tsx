  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center animate-fade-in-up">
          {/* Left Content */}
          <div className="text-center lg:text-left">
            ...
            {/* Main Heading */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-4 sm:mb-6 text-shadow leading-tight">
              Transforme Vidas
              <br />
            ...
            {/* Features */}
            <div className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start gap-4 sm:gap-6 mb-8 sm:mb-10">
            ...
            {/* Stats */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mt-12 sm:mt-16 pt-6 sm:pt-8 border-t border-luxury/20">
              <div className="text-center lg:text-left">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative max-w-md w-full">
              <video
                ...
                muted
                playsInline
                className="w-full h-auto rounded-2xl shadow-2xl border border-luxury/20"
              >
